...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Actualizar habitación | Hotel "DECAMERON"</title>
									...
									<div class="card-body">
										...
										<div class="row gutters">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													<textarea class="form-control" value="<?php echo $d->detaha ?>" name="hdet" id="message" placeholder="Tipo de habitación"  rows="3"><?php echo $d->detaha ?></textarea>
